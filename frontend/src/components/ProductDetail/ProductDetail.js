...
const ProductDetailPage = () => {
  ...
  return (
    <Box sx={{ backgroundColor: "#0d0d0d", py: 8, color: "#fff", minHeight: "100vh" }}>
      <Container maxWidth="lg">
        {/* IMAGE + TEXT + YOUTUBE SIDE BY SIDE */}
  ...
  <Grid item xs={12} md={6}>
    <Typography variant="h3" fontWeight={900} sx={{ fontSize: "2.2rem" }}>
      {title}
    </Typography>
    <Divider sx={{ borderColor: "#333", my: 1.5 }} />
    <Typography variant="body1" sx={{ color: "#ccc", whiteSpace: "pre-line" }}>
      {description}
    </Typography>
  </Grid>
  ...
  <Box sx={{ width: "100%", maxWidth: 340, ml: 25 }}>
    <YouTubePlayer url={audioPreviewUrl} />
        ...
        {/* LICENSE DROPDOWN (optional fallback) */}
        {type === "beat" && (
        ...
        <Typography
          variant="h4"
          fontWeight={700}
          sx={{ mt: 2, color: "primary.main", fontSize: isMobile ? "1.4rem" : "1.8rem" }}
        >
        ...
        <Button
          ...
          sx={{ mt: 3, borderRadius: 30, px: 5, py: 1.5, fontWeight: 700, fontSize: "1rem" }}
        >
          Add to Cart
        </Button>
