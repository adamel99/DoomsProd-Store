        ...
        >
          <Box
            ...
            sx={{
              ...
              // Rose accent line — sits on top of shimmer
              "&::after": {
                content: '""',
                position: "absolute",
          ...
          >
            ...
            <Box sx={{
              ...
              {/* Deep gradient scrim — stronger at bottom for content legibility */}
              <Box sx={{
                    ...
                    >
                      <IconButton
                        ...
                        sx={{
                          ...
                          // Neumorph-glass hybrid: raised surface with inset top highlight
              ...
              {/* Waveform — sits just above bottom edge */}
              {isPlaying && (
                <Box sx={{
            ...
            <CardContent sx={{ flex: 1, display: "flex", flexDirection: "column", p: 3 }}>
              ...
              {/* Thin rule under title — replaces any decorative filler */}
              ...
              {/* License select — neumorph inset field */}
              ...
              {/* Add to Cart — raised neumorph button */}
              <Button
                variant="contained"
